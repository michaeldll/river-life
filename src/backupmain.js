...
function setupEnd() {
    ...
    planeEndGeometry = new THREE.PlaneGeometry(
        planeEndSize.w,
        planeEndSize.h,
        planeEndSide,
        planeEndSide,
...
function setupGUI() {
    ...
    // planeFolder.add(planeMouth.position, 'y', 40, 51).listen();
    // planeFolder.add(planeMouth.position, 'z', -80, -60).listen();
    ...
    // planeFolder.add(planeMouth.rotation, 'z', -0.6, -0.4).listen();
    // planeFolder.open();
    ...
    //     if (line) {
    //         clearInterval(check);
    //         let planeFolder = gui.addFolder('Line');
    //         planeFolder.add(line.position, 'x', -5, 5).listen();
    //         planeFolder.add(line.position, 'y', 30, 60).listen();
    //         planeFolder.add(line.position, 'z', -85, -65).listen();
    //         planeFolder.add(line.scale, 'x', -5, 5).listen();
    //         planeFolder.add(line.scale, 'y', -5, 5).listen();
    //         planeFolder.add(line.scale, 'z', -5, 5).listen();
    //         planeFolder.add(line.rotation, 'z', 0.8, 1.2).listen();
    //         planeFolder.close();
    //     }
    // }, 200);
    ...
    //         let planeFolder2 = gui.addFolder('Plane End');
    //         planeFolder2.add(planeEnd.position, 'x', -5, 5).listen();
    //         planeFolder2.add(planeEnd.position, 'y', 30, 60).listen();
    //         planeFolder2.add(planeEnd.position, 'z', -85, -65).listen();
    //         planeFolder2.add(planeEnd.scale, 'x', -5, 5).listen();
    //         planeFolder2.add(planeEnd.scale, 'y', -5, 5).listen();
    //         planeFolder2.add(planeEnd.scale, 'z', -5, 5).listen();
    //         planeFolder2.add(planeEnd.rotation, 'z', 0.8, 1.2).listen();
    //         planeFolder2.close();
    //         setInterval(() => {
    //             console.log(planeEnd);
    //         }, 500);
    ...
    let planeFolder = gui.addFolder('Model Fish');
    planeFolder.add(models[1].position, 'x', -100, 100).listen();
    planeFolder.add(models[1].position, 'y', -100, 100).listen();
    planeFolder.add(models[1].position, 'z', -80, -60).listen();
    planeFolder.add(models[1].scale, 'x', -5, 5).listen();
    planeFolder.add(models[1].scale, 'y', -5, 5).listen();
    planeFolder.add(models[1].scale, 'z', -5, 5).listen();
    planeFolder.add(models[1].rotation, 'z', -0.6, -0.4).listen();
    planeFolder.open();
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    if (currentSetPiece === 0) {
                        // console.log(sprites[0].material.opacity);
                        if (!data.one.moving) {
...
function render() {
    ...
    if (percent >= 99 && isMusicAvailable() && getMusicPlayer('ambience')) {
    ...
    if (currentSetPiece === 1) adjustFish(smallOffset);
        ...
        switch (currentSetPiece) {
            ...
            case 2:
                ...
                setTimeout(() => {
                    ...
                    removeEntity(planeMiddleRight);
                    removeEntity(planeMiddleLeft);
                    removeEntity(planeMiddle);
    ...
    // console.log(planeMouth.rotation, planeMouth.position);

...
} from './jsm/shaders/GodRaysShader.js';
var container, stats;
...
function render() {
    ...
    if (postprocessing.enabled) {
        ...
        postprocessing.godrayGenUniforms['vSunPositionScreenSpace'].value.x =
            screenSpacePosition.x;
        postprocessing.godrayGenUniforms['vSunPositionScreenSpace'].value.y =
            screenSpacePosition.y;
        postprocessing.godraysFakeSunUniforms[
            'vSunPositionScreenSpace'
        ].value.x = screenSpacePosition.x;
        postprocessing.godraysFakeSunUniforms[
            'vSunPositionScreenSpace'
        ].value.y = screenSpacePosition.y;
        // -- Draw sky and sun --
